        ...
        let tableHeaders = (
            <div className="row">
              <div className="offset-lg-1 col-lg-10 col-12">
                ...
                <div className={`col-sm-2 col-1 game-price table-header curr-header text collection-price1`} id='price1'><strong>Target Price</strong></div>
                <div className={`col-2 game-price table-header base-header text collection-price2`} id='price2'><strong>Current Price</strong></div>
                </div>
              </div>
            </div>
        )
